...
if __name__ == "__main__":
    forecast_file = "NFL/test_final/LR_model_straw_men_2_combined_data.csv"
    dir = "NFL/ML/dataset_interpolated_fixed"
    combine_csv_files("LR_model_straw_men_2", "test_final")
    train_years = [2021, 2022, 2023]
    test_years = [2024, 2025]
    save_plot = "NFL/test_final/plot_LR_model_straw_men_2.png"
    save_p_val = "NFL/test_final/p_val_LR_model_straw_men_2.txt"
    features = ["score_difference", "relative_strength", "end.yardsToEndzone", "end.down", "end.distance"]
    p_val = run_test(dir, train_years, test_years, forecast_file, features, num_bucketers=50, num_buckets=5, phat_A="ESPN", phat_B="Logistic Regression", save_plot=save_plot, save_p_val=save_p_val)
    print(p_val)